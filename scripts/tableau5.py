...
# Reset dates back to start for the next facility
    ...
    for x in range(4):
        ...
        with_demographics["incidprev"] = "Incident"
        ...
        jfm3 = with_demographics[
            ...
            )  # Sending facility matches
            & (
                with_demographics["admissionsourcecode"].isnull()
            )  # Admission source is not specified
        ]
