...
def age(
    ...
    patient_cohort["decimalage"] = (reference_date - patient_cohort["birthtime"]).dt.days / 365.25
    patient_cohort["age"] = pd.cut(patient_cohort["decimalage"], bins=bins["bins"], labels=bins["labels"], include_lowest=True) 
