...
# placed long descriptions here as globals since they look kind of ugly inline
ALL_PATIENTS_HOME_THERAPIES_DESC = """
All Patients Home Therapies 
---------------------------
For a specified unit and time window contains:  
    - Number of patients on Haemodialysis 
      Defined as the number of patients registered for haemodialysis, haemofiltration, haemodiafiltration or ultrafiltration treatments.
    - Number of patients on Peritoneal Dialysis
      Defined as the number of patients registered for CAPD or APD treatments.
    - Number of patients on home therapies 
      Total number of patients on Peritoneal Dialysis as defined above combined with the number of patients on heamodialysis on home therapies.
    - Number of patients on In centre therapies
...
INCIDENT_HOME_THERAPIES_DESC = """
Incident Patients Home Therapies 
--------------------------------
For a specified unit and time window contains:  
    - Number of incident patients on Haemodialysis. 
      Defined as the number of patients registered for haemodialysis, haemofiltration, haemodiafiltration or ultrafiltration treatments.
    - Number of incident patients on Peritoneal Dialysis.
      Defined as the number of patients registered for CAPD or APD treatments.
    - Number of incident patients on home therapies. 
      Total number of patients on Peritoneal Dialysis as defined above combined with the number of patients on heamodialysis on home therapies.
...
PREVELENT_HOME_THERAPIES_DESC = """
Prevalent Patients Home Therapies 
--------------------------------
For a specified unit and time window contains:  
    - Number of prevalent patients on Haemodialysis. 
      Defined as the number of patients registered for haemodialysis, haemofiltration, haemodiafiltration or ultrafiltration treatments.
    - Number of prevalent patients on Peritoneal Dialysis.
      Defined as the number of patients registered for CAPD or APD treatments.
    - Number of prevalent patients on home therapies. 
      Total number of patients on Peritoneal Dialysis as defined above combined with the number of patients on heamodialysis on home therapies.
    - Number of prevalent patients on In centre therapies.
      Total number of patients registered for Haemodialysis in-centre

Incidence in this instance is defined as the patients who begin treatment within the time window and have no other registered dialysis or transplant modalities. 
"""

INCENTRE_DIALYSIS_FREQ_DESC = """



"""

INCIDENT_INITIAL_ACCESS_DESC = """
Patients registered as having 
"""

DISCLAIMER = """
DISCLAIMER
The statistics presented here are are automatically calculated from data contained within the UKRDC and are presented for the convenience of data coordinators rather than an accurate audit of performance.   
"""
    ...
    def _calculate_all_home_therapies(self):
        ...
        return LabelledNetwork(
            metadata=NetworkMetaData(
                ...
                description=ALL_PATIENTS_HOME_THERAPIES_DESC + DISCLAIMER,
            ),
